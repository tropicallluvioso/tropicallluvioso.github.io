...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "Tropical Lluvioso  " }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<div class="container-slides">
      ...
      ${dataRes.map(
    (person) => renderTemplate`<img loading="lazy" class="slide"${addAttribute(person.picture.large, "src")} alt="">`
  )}
...
${dataRes.map(
    (person) => renderTemplate`<figure class="card"><img${addAttribute(person.picture.large, "src")}>
    <figcaption>
...
const $$StrategicComm = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "Tropical Lluvioso  " }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<div class="container-slides">
      ...
      ${dataRes.map(
    (person) => renderTemplate`<img class="slide" loading="lazy"${addAttribute(person.picture.large, "src")} alt="">`
  )}
...
${dataRes.map(
    (person) => renderTemplate`<figure class="card"><img loading="lazy"${addAttribute(person.picture.large, "src")}>
